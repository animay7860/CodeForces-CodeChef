...
void solveTestCases()
{
    ...
    //     fo(i,n-1){
    //         if(arr2[i] > arr1[i] and arr2[i]<= arr1[n-1]){
    //             swap(arr1[i], arr2[i]);
    //         }
    //     }
    // }
    // else if(arr2[n-1]> arr1[n-1]){
    //     fo(i,n-1){
    //         if(arr1[i] > arr2[i] and arr1[i]<= arr2[n-1]){
    //             swap(arr1[i], arr2[i]);
    //         }
    //     }
    // }
...
// print(arr1);
// print(arr2);
    ll ax=*max_element(all(arr1));
    ll bx=*max_element(all(arr2));
    if(ax==arr1[n-1] and bx==arr2[n-1]){
        print("Yes");
    }
    else{
        print("No");
