...
ll dp[maxN];
long long solveTestCases(ll a, ll b, ll c, ll n)
{

    // Question is of Unbounded Knapsack
    // Try to write Recursive Code for this.
    if (n == 0)
    {
        return 0;
    }
    ...
    return dp[n] = 1 + max(solveTestCases(a, b, c, n - a), max(solveTestCases(a, b, c, n - b), solveTestCases(a, b, c, n - c)));
}
