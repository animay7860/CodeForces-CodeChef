...
void solveTestCases()
{
    ll r, sa, n, a, b, c, d, m = 0, k = 0, p = 0, q = 0;
    cin >> m >> n;
    cin >> a >> b >> c >> d;
    if ((a == 1 and b == 1) or (c == 1 and d == n) or (c == m and d == n) or (c == 1 and d == 1) or (a == 1 and b == n) or (a == m and b == 1) or (a == m and b == n) or (c == m and d == 1))
    {
        print(2);
    }
    else if ((a == 1 or b == 1) or (c == 1 or d == 1) or (a == m) or (b == n) or (c == m) or (d == n))
    {
        print(3);
    }
    else
