...
void solveTestCases()
{
    ...
    if (ans[0].first == ans[1].first and ans[0].first == ans[2].first and min(ans[0].second, ans[1].second) < ans[2].second and max(ans[0].second, ans[1].second) > ans[2].second)
    {
        print(abs(ans[0].first - ans[1].first) + abs(ans[0].second - ans[1].second) + 2);
    }
    else if (ans[0].second == ans[1].second and ans[0].second == ans[2].second and min(ans[0].first, ans[1].first) < ans[2].first and max(ans[0].first, ans[1].first) > ans[2].first)
    {
        print(abs(ans[0].first - ans[1].first) + abs(ans[0].second - ans[1].second) + 2);
    }
    else
    {
        print(abs(ans[0].first - ans[1].first) + abs(ans[0].second - ans[1].second));
    }
